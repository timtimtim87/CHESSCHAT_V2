const ERROR_CATALOG = {
  ...
  TAKEBACK_NOT_ALLOWED: { message: "Takeback is not allowed right now.", retryable: false },
  TAKEBACK_WINDOW_CLOSED: { message: "Takeback window is closed.", retryable: false },
  TAKEBACK_LIMIT_REACHED: { message: "No takebacks remaining.", retryable: false },
  DRAW_ALREADY_PENDING: { message: "A draw offer is already pending.", retryable: false },
  DRAW_NOT_PENDING: { message: "No draw offer is pending.", retryable: false },
